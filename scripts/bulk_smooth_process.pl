...
my $stat_lamda = $ARGV[4];
my $stat_alpha = $ARGV[5];
my $stat_wraw = $ARGV[6];
...
for (my $i=0; $i<@glob; $i++)
{
	...
	print "perl $script_path/smooth_parent_inv.pl $input_path/$prefix_group.geneks_1st $input_path/$prefix_group.pairks $stat_lamda $stat_alpha $stat_wraw > $input_path/$prefix_group.geneks_2nd\n";
	...
	print "perl $script_path/smooth_lastleaf_inv.pl $input_path/$prefix_group.geneks_2nd $input_path/$prefix_group.geneks_2nd_val $input_path/$prefix_group.pairks $input_path/$prefix_group.nodeinfo_ks $stat_lamda $stat_alpha $stat_wraw > $input_path/$prefix_group.geneks_3rd\n";
	...
	print "perl $script_path/smooth_inbetween_inv.pl $input_path/$prefix_group.geneks_3rd $input_path/$prefix_group.geneks_3rd_val $input_path/$prefix_group.pairks $input_path/$prefix_group.nodeinfo_ks $input_path/$prefix_group.geneks_4th $stat_lamda $stat_alpha $stat_wraw\n";
